...
(function() {
	...
	MarchingLines = function(pos, dir, color, bmp) {
		this.pos      = pos;
		this.startPos = vec3.create(this.pos);
		this.dir      = dir;
		this.color    = hexToRgb(color);

		this.speed    = vec3.create(dir);
		this.bmp      = bmp;
		vec3.normalize(this.speed);
		...
		this.shadows = vec3.create(this.dir);
		mat4.multiplyVec3(m, this.shadows);
		vec3.normalize(this.shadows);
	}

	var p = MarchingLines.prototype;


	p.walk = function() {
		vec3.add(this.pos, this.speed);	
	};
